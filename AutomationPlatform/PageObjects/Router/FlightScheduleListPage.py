...
class FlightScheduleListPage(BasePage):
    ...
    def verify_flight_created(self):
        self.click(self.LOC_Close_Btn)
        if self.get_text(self.LOC_Verify_Flight_Schedule, "Test_flight_schedule"):
            ExpectedFlightName = self.get_element_text(self.LOC_Verify_Flight_Schedule)
            assert ExpectedFlightName == "Test_flight_schedule"
        pass
